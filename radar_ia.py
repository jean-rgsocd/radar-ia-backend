...
# Versão 9.0 - FINAL (Correção Definitiva do Header 'x-rapidapi-host')
...
app = FastAPI(title="Radar IA - API Definitiva V9.0")
...
# CORREÇÃO DEFINITIVA: Adicionado o header 'x-rapidapi-host'
HEADERS = {
...
def get_live_stats_for_game(game_id: int):
    ...
    try:
        ...
        return data[0] # Retorna o objeto completo do fixture
    except requests.RequestException as e:
